...
const UserInfo = () => {
    ...
    return (
        <div className="user-info p-6 rounded-lg shadow-lg max-w-md mx-auto">
            <div className="flex items-center space-x-4">
                <img src={userImage} alt="User Profile" className="w-24 h-24 rounded-full object-cover border-2 border-gray-300" />
